          ...
          <div className="flex items-center justify-between py-3 lg:py-4">
            ...
            <div className="flex items-center gap-2 sm:gap-3 lg:gap-4">
                  ...
                  <>
                    {user ? (
                      ...
                      <div className="flex items-center gap-2">
                        <Link
                          href={getSignInUrl()}
                          className="text-sm font-semibold text-gofarm-gray hover:text-gofarm-light-green hoverEffect"
                        >
                          Sign In
                        </Link>
                        <Link
              ...
              <div className="flex md:hidden items-center gap-1">
                <CartIcon />
                {loading ? (
                  <div className="flex items-center py-2 px-2 rounded-xl border border-gray-200 animate-pulse">
                    <div className="w-8 h-8 rounded-full bg-gray-200" />
                  </div>
                ) : (
                  <>
                    {user ? (
                      <>
                        ...
                        {isVendor && (
                          <Link
                            href="/vendor/dashboard"
                            className="flex items-center p-2 bg-green-50 hover:bg-green-100 border border-green-200 rounded-lg transition-all duration-200"
                          >
                            <Store className="w-4 h-4 text-green-600" />
                          </Link>
                        )}
                      ...
                      <Link
                        href={getSignInUrl()}
                        className="text-xs font-semibold text-gofarm-green hover:text-gofarm-light-green hoverEffect px-2"
                      >
                        Sign In
                      </Link>
                    )}
