...
const AdminAnalytics = () => {
  ...
  const StatCard = ({
    ...
    return (
      <Card className="group hover:shadow-xl transition-all duration-300 border-gofarm-light-green/20 hover:border-gofarm-light-green/40 overflow-hidden">
        ...
        <CardContent className="space-y-3">
          <div className="space-y-1">
            ...
            {subtitle && (
              <div className="text-xs text-gofarm-gray">{subtitle}</div>
            )}
          </div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-gofarm-gray">vs last period</span>
          </div>
        </CardContent>
      </Card>
    );
  ...
  return (
    <div className="p-6 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gofarm-black flex items-center gap-3">
            <BarChart3 className="w-8 h-8 text-gofarm-light-green" />
            Business Analytics
          </h1>
          <p className="text-gofarm-gray mt-1">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            ...
            className="border-gofarm-light-green/20 hover:border-gofarm-light-green"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="border-gofarm-light-green/20">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <PieChart className="w-5 h-5 text-gofarm-light-green" />
        ...
        >
          <Card className="border-gofarm-light-green/20">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <TrendingUp className="w-5 h-5 text-gofarm-light-green" />
            ...
            <CardContent>
              <div className="space-y-3">
                {analytics?.topProducts?.slice(0, 5).map((product, index) => (
                  ...
                  >
                    <div>
                      <div className="font-medium text-sm text-gofarm-black">
                        {product.name}
                      </div>
                    ...
                    <Badge className="bg-gofarm-light-green/20 text-gofarm-green">
                      ${product.revenue.toLocaleString()}
                    </Badge>
                  </div>
                )) || (
                  <div className="text-center py-6 text-gofarm-gray">
      ...
      >
        <Card className="border-gofarm-light-green/20">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <Activity className="w-5 h-5 text-gofarm-light-green" />
          ...
          <CardContent>
            <div className="space-y-3">
              {analytics?.recentActivity?.slice(0, 8).map((activity, index) => (
                <div
                  key={index}
                  className="flex items-center justify-between p-3 border border-gofarm-light-green/10 rounded-lg"
                >
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-gofarm-light-green rounded-full"></div>
                    <span className="text-sm text-gofarm-black">
                      {activity.action}
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
