    ...
    <div className="py-10 md:py-20 bg-linear-to-b from-blue-50 to-white flex items-center justify-center p-4">
      ...
      >
        ...
        <div>
          <Link
            href="/"
            className="block bg-gofarm-black/5 border border-gofarm-black/20 text-center py-2.5 rounded-full text-sm font-semibold tracking-wide hover:border-gofarm-black hover:bg-gofarm-black hover:text-white hoverEffect"
          >
            Discover Products
          </Link>
        </div>
